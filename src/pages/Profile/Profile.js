...
const Profile = () => {
    ...
    return (
        <section className='bg-white px-4 lg:px-40 h-screen overflow-scroll w-full'>
            <section>
                <div className='text-center mx-auto lg:shadow-xl rounded-xl p-10 m-10 border'>
                    <h1 className='text-xl lg:text-2xl font-bold text-primary uppercase tracking-wider mb-5'>Profile of {user?.displayName}</h1>
