        ...
        <section>
            <div className='flex text-center md:w-5/6 lg:w-4/6 md:mx-auto lg:mx-auto shadow-xl rounded-xl border m-5 lg:m-10 items-center'>
                <div className='flex-1 hidden md:block'>
                    <img className='h-[535px] w-full rounded-l-xl' src={LoginImage} alt="" />
                </div>
                <div className='flex-1'>
                    <div className='flex justify-end p-5 gap-3'>
                        <p className='text-sm mt-2'>Already have account?</p>
                        <button onClick={() => navigate('/login')} className='btn btn-sm btn-primary btn-outline rounded-md'>Login</button>
                    </div>
                    <div className='p-8'>
