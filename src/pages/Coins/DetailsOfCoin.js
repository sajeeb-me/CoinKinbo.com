        ...
        <section>
            <div className='text-left px-4 lg:px-20 my-5 lg:my-20'>
                <div className='grid grid-cols-1 lg:grid-cols-2 items-center gap-y-5'>
                    <div>
                        <p><small className='bg-secondary px-3 py-1 rounded-md text-white'>Rank#{coin.market_cap_rank}</small></p>
                        <div className='flex gap-2 my-3'>
                            <img src={coin.image?.thumb} alt="" />
                            <p className='text-xl font-semibold'>{coin.name} (<span className='uppercase'>{coin.symbol}</span>)</p>
                        </div>
                        ...
                        <div className='grid grid-cols-2 gap-5 opacity-90'>
                            ...
                            <div>
                                <div className='lg:flex justify-between py-3 border-b'>
                                    ...
                                    <p className='font-medium'>{(coin.market_data?.circulating_supply ? coin.market_data?.circulating_supply : 'Not found')?.toLocaleString("en-US")}</p>
                                </div>
                                <div className='lg:flex justify-between py-3 border-b'>
                                    <p>Total Supply</p>
                                    <p className='font-medium'>{(coin.market_data?.total_supply ? coin.market_data?.total_supply : 'Not found')?.toLocaleString("en-US")}</p>
                                </div>
                                <div className='lg:flex justify-between py-3 border-b'>
                                    <p>Max Supply</p>
                ...
                <div className='mt-10'>
                    ...
                    <p className='lg:text-justify opacity-90 font-light'> {(coin.description?.en)?.slice(0, 500)}. </p>
                </div>
            </div>
            <Footer />
        </section>
